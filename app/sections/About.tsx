            ...
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
                ...
                <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
                    <div className="mb-10 flex w-[100%] flex-col gap-4 text-[12px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
                        <AnimatedBody text="I'm Isuru Udara Senadeera, and I'm on a journey to transform ideas into digital reality. Hailing from Uva Wellassa University, I wear multiple hats as the founder of Ceriture – a platform that turns the cool and crazy ideas of university students into tangible projects. At the core, I'm passionate about providing valuable development experiences for my fellow students, fostering innovation, and making things happen." />
